<template>
  <div
    :style="{
      ...
      width: '1200px',
      position: 'relative',
      borderStyle: 'solid dashed double double',
    }"
  >
    <el-form
    ...
    >
      ...
      >
        <el-select
          ...
          v-model="ruleForm.yishengzhanghao"
          placeholder="请选择医生账号"
        >
          <el-option
...
export default {
  ...
  methods: {
    ...
    init(type) {
      ...
      this.$http
        .get("option/yisheng/yishengzhanghao", { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
      ...
      this.$http
        .get("option/keshi/keshi", { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
    ...
    yishengzhanghaoChange() {
      this.$http
        .get(
          "follow/yisheng/yishengzhanghao?columnValue=" +
            this.ruleForm.yishengzhanghao,
          { emulateJSON: true }
        )
        .then((res) => {
          if (res.data.code == 0) {
    ...
    info(id) {
      this.$http
        .get("VisitingDoctor/detail/${id}", { emulateJSON: true })
        .then((res) => {
          if (res.data.code == 0) {
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          ...
          if (crossrefid && crossuserid) {
            ...
            this.$http
              ...
              .then((res) => {
                if (res.data.data.total >= crossoptnum) {
                  ...
                  this.$http
                    .post("VisitingDoctor/add", this.ruleForm)
                    .then((res) => {
                      if (res.data.code == 0) {
                        this.$message({
                          message: "操作成功",
            ...
            this.$http.post("VisitingDoctor/add", this.ruleForm).then((res) => {
              if (res.data.code == 0) {
                this.$message({
                  message: "操作成功",
                  type: "success",
