<template>
  <div class="main-containers">
    ...
    >
      ...
      />
      <div v-if="true" :style="{ color: '#00 0', fontSize: '28px' }">
        个人健康监控平台
      </div>
      <div>
        <div
      ...
      :style="
        'horizontal' == 'vertical'
          ...
          : {
              ...
              position: 'relative',
              background:
                'url(http://codegen.caihongy.cn/20221117/38e5e7b28ead44818736f496c2105696.jpg) no-repeat right 500px,url(http://codegen.caihongy.cn/20221117/84d9df1596cc43c28e3a36058c6a89da.png) no-repeat left bottom,#f7f8fc',
            }
      "
    >
      <div
        ...
        :style="{
          ...
          borderColor: '#efefef',
          background:
            'url(http://codegen.caihongy.cn/20221114/1fde69930e764ee1acd7026e05e4c7ee.jpg) no-repeat center top',
      ...
      >
        ...
        >
          ...
          <el-menu-item
            ...
            v-if="Token && notAdmin"
            @click="goMenu('/index/healthindex')"
          >
            <i
              v-if="true"
              :style="{
      ...
      <div
        ...
        :style="{
          ...
          alignItems: 'center',
          background:
            'url(http://codegen.caihongy.cn/20221114/5ee2a2d898f04e6498db12f9e81d7350.jpg) repeat-y center top',
