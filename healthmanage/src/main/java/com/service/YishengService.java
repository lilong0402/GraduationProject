...
public interface YishengService extends IService<YishengEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<YishengEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<YishengEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<YishengEntity> wrapper);
