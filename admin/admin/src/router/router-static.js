...
import jibingpinggu from "@/views/modules/jibingpinggu/list";
import keshi from "@/views/modules/keshi/list";
import VisitingDoctor from "@/views/modules/VisitingDoctor/list";
