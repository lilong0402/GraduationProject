    ...
    >
      <template>
        ...
        <el-form-item
          :style="{ width: '50%', margin: '0 0 20px 0' }"
          class="input"
          v-else-if="ruleForm.yishengzhanghao"
          label="医生账号"
          prop="yishengzhanghao"
        >
          <el-input
        ...
        <el-form-item
          :style="{ width: '50%', margin: '0 0 20px 0' }"
          class="input"
          v-else-if="ruleForm.chuzhenriqi"
          label="出诊日期"
          prop="chuzhenriqi"
        >
          <el-input
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          if (crossrefid && crossuserid) {
                    ...
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.VisitingDoctorCrossAddOrUpdateFlag = false;
                          this.parent.search();
            ...
            this.$http({
              url: `VisitingDoctor/${!this.ruleForm.id ? "save" : "update"}`,
              method: "post",
              data: this.ruleForm,
            }).then(({ data }) => {
              if (data && data.code === 0) {
